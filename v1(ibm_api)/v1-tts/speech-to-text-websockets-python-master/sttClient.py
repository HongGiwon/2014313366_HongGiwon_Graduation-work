...
def tts_word(word):
    text_to_speech = TextToSpeechV1(username='9a69aac9-77b4-4f02-a9e5-42fd4cd14b86',password='eFmlM1Xr3Gvb',x_watson_learning_opt_out=True)
...
def censor_audio(audiofile, c_time_list, c_word_arr):
    audioSound = AudioSegment.from_wav(audiofile[0])
